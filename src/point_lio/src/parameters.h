...
extern std::string lid_topic, imu_topic, pcd_path;
...
extern double max_match_sq_dist, max_plane_normal_z;
extern double body_z_min, body_z_max;
extern double body_min_xy_range, body_max_xy_range;
