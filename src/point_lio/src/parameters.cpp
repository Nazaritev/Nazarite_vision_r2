...
std::string lid_topic, imu_topic, pcd_path;
...
double max_match_sq_dist = -1.0, max_plane_normal_z = 1.1;
...
void readParameters(shared_ptr<rclcpp::Node> &nh)
{
  ...
  nh->declare_parameter<double>("mapping.max_match_sq_dist", -1.0);
  nh->declare_parameter<double>("mapping.max_plane_normal_z", 1.1);
  nh->declare_parameter<double>("mapping.body_z_min", -100.0);
  nh->declare_parameter<double>("mapping.body_z_max", 100.0);
  nh->declare_parameter<double>("mapping.body_min_xy_range", 0.0);
  nh->declare_parameter<double>("mapping.body_max_xy_range", -1.0);
  ...
  nh->declare_parameter<string>("pcd_save.pcd_path", string(ROOT_DIR) + "PCD/scan.pcd");
  ...
  nh->get_parameter("mapping.max_match_sq_dist", max_match_sq_dist);
  nh->get_parameter("mapping.max_plane_normal_z", max_plane_normal_z);
  nh->get_parameter("mapping.body_z_min", body_z_min);
  nh->get_parameter("mapping.body_z_max", body_z_max);
  nh->get_parameter("mapping.body_min_xy_range", body_min_xy_range);
  nh->get_parameter("mapping.body_max_xy_range", body_max_xy_range);
  ...
  nh->get_parameter("pcd_save.pcd_path", pcd_path);
